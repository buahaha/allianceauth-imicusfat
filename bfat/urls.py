...
urlpatterns = [
    ...
    url(r'^stats/ally/$', views.stats_ally, name='stats_ally'),
    url(r'^stats/ally/(?P<allianceid>[0-9]+)/$', views.stats_ally, name='stats_ally'),
    url(r'^stats/ally/(?P<allianceid>[0-9]+)/(?P<month>[0-9]+)/(?P<year>[0-9]+)$', views.stats_ally, name='stats_ally'),
